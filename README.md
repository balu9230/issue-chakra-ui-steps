...
# ------------------ chakra-ui-steps.es.js (in this file, error is at line 415 since code starts from line 101; I've also put a comment called '//ERROR') ------------------ #
...
const Step = forwardRef$1((props, ref) => {
  ...
  }, [stepIconContainer.width, stepIconContainer.height]); //ERROR
  return jsx(Fragment, {
